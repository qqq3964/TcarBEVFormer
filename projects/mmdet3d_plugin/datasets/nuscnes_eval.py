...
def custom_load_gt(nusc: NuScenes, eval_split: str, box_cls, verbose: bool = False):
    """
            ...
            if box_cls == DetectionBox_modified:
                ...
                sample_boxes.append(
                    box_cls(
                        ...
                        velocity=sample_annotation['velocity'][:2],
...
def custom_add_center_dist(nusc: NuScenes,
    ...
    for sample_token in eval_boxes.sample_tokens:
        ...
        for box in eval_boxes[sample_token]:
            ...
            # Note that tcar is predefined the ego coordinate so we conduct minus 0
...
class NuScenesEval_custom(NuScenesEval):
    ...
    def __init__(self,
        ...
        self.pred_boxes, self.meta = load_prediction(self.result_path, self.cfg.max_boxes_per_sample, CustomDetectionBox,
                                                     verbose=verbose)
        self.gt_boxes = custom_load_gt(self.nusc, self.eval_set, DetectionBox_modified, verbose=verbose)
