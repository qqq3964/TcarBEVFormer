...
class CustomTcarDataset(NuScenesDataset):
    r"""NuScenes Dataset.
    ...
    def __init__(self, queue_length=4, bev_size=(200, 200), overlap_test=False, *args, **kwargs):
        ...
        self.eval_detection_configs.class_names = kwargs['classes']
        self.eval_detection_configs.class_range = {cls: 50 for cls in kwargs['classes']}
